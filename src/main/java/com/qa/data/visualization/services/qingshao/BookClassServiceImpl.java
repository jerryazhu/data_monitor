    ...
    public ArrayList getBookRankAge(String data){
        ...
        for (Object aLevels : levels) {
            for(int i=0;i<9;i++) {
                ...
                if (list1.size() < 1) {
                    switch (i){
                        case 0:number0.add(0);break;
                        case 1:number1.add(0);break;
                        case 2:number2.add(0);break;
                        case 3:number3.add(0);break;
                        case 4:number4.add(0);break;
                        case 5:number5.add(0);break;
                    ...
                    for (Object[] result : list1) {
                        switch (i){
                            case 0:number0.add(result[1]);break;
                            case 1:number1.add(result[1]);break;
                            case 2:number2.add(result[1]);break;
                            case 3:number3.add(result[1]);break;
                            case 4:number4.add(result[1]);break;
                            case 5:number5.add(result[1]);break;
                            case 6:number6.add(result[1]);break;
                            case 7:number7.add(result[1]);break;
                            case 8:number8.add(result[1]);break;
                        }
                    }
                }
            }
